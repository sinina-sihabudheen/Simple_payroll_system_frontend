...
export default function AllowancePage() {
  ...
  const fetchAllowances = async () => {
    try {
      const res = await axiosInstance.get("/api/salary/allowances/");
  ...
  const handleCreate = async () => {
    ...
    try {
      await axiosInstance.post("/api/salary/allowances/", {
        name,
        description,
      });
  ...
  const handleDelete = async (id) => {
    try {
      await axiosInstance.delete(`/api/salary/allowances/${id}/`);
    ...
    <div className="flex flex-col h-screen">
        ...
        <div className="flex h-screen">
            ...
            <div className="p-6 max-w-2xl mx-auto relative">
                ...
                <h1 className="text-2xl font-bold text-blue-700">Allowances</h1>
                <button
                ...
                <table className="w-full border text-left">
                    ...
                    {allowances.map((allowance, index) => (
                        ...
                        <td className="border px-4 py-2">{allowance.description}</td>
                ...
                <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-10">
                    ...
                    <h2 className="text-xl font-semibold mb-4">Add Allowance</h2>
                    <input
                        type="text"
