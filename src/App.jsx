  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Protected — all share AdminLayout (Navbar + Sidebar) */}
        <Route
          element={
            <PrivateRoute>
              <AdminLayout />
        ...
        >
          ...
          <Route path="/admin/device-settings" element={<DeviceSettingsPage />} />
          <Route path="/admin/employees-leaves" element={<EmployeeLeavesPage />} />
          <Route path="/admin/leave-types" element={<LeaveTypePage />} />
          <Route path="/admin/deductions" element={<DeductionPage />} />
          <Route path="/admin/reports" element={<ReportsPage />} />
          <Route path="/admin/reports/employees" element={<EmployeesReportPage />} />
          <Route path="/admin/reports/attendance" element={<AttendanceReportPage />} />
          <Route path="/admin/reports/salary" element={<SalaryReportPage />} />
          <Route path="/admin/reports/deductions" element={<DeductionsReportPage />} />
        </Route>
      </Routes>
    </Router>
  );
